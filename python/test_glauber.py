...
class TestDynamicIndices:
    ...
    def test_small_bitmap(self, class_to_test: type[GlauberSim], tmpdir):
        ...
        result = sim.run_single_glauber(False)
        assert result["fixation"] == True and result["iterations"] == 109
...
@pytest.mark.parametrize("class_to_test", (GlauberFixedIndexTorus,))
class TestFixedTorus:
    def test_small_1(self, class_to_test: type[GlauberSim], tmpdir):
        tmpdir = str(tmpdir)
        sim = class_to_test(
            padding=0,
...
@pytest.mark.parametrize("class_to_test", (GlauberDynIndexTorus,))
class TestDynTorus:
    def test_small_1(self, class_to_test: type[GlauberSim], tmpdir):
        tmpdir = str(tmpdir)
        sim = class_to_test(
...
if __name__ == "__main__":
    sys.exit(
        pytest.main(["-c", "pyproject.toml", "--durations=0", "-k", "small_1 and Dyn"])
    )
